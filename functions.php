...
function twenty_twenty_one_scripts() {
	...
	//Colocando css e js dos tema RCC E IBICT
	$ver = time();
	...
	wp_register_style( 'ibictstyle-class', get_template_directory_uri() . '/assets/css/ibictstyle.css', false, $ver );
	wp_enqueue_style ( 'ibictstyle-class' ); // style ibict
